...
describe('Location Ops', async function() {
  it('Expect coordinates 32.8328,-117.2713 to return the address 6903 Fay Ave, La Jolla, CA 92037, USA', async function() {
    const payload = {
      geo: {
        coordinates: [32.8328,-117.2713]
      }
    };
    const expectedRes = { locationDate: undefined,
