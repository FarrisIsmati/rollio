...
const setVendorActive = async (region, vendor) => {
  ...
  await regionOps.incrementRegionDailyActiveVendorIDs({regionID: region._id, vendorID: vendor._id});
  //Set daily active of vendor to true
  await vendorOps.updateVendorSet({regionID: region._id,vendorID: vendor._id,field: 'dailyActive',data: true})
}
